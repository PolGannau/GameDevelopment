...
void j1Render::UpdateCamera()
{
	...
	if (App->entitymanager->player->speed.x > 0.0f && App->entitymanager->player->position.x + App->entitymanager->player->collider->rect.w > right_limit)
	{
	...
	if (App->entitymanager->player->speed.x < 0.0f && App->entitymanager->player->position.x  <= left_limit)
	{
		App->render->camera.x += -App->entitymanager->player->speed.x;
	...
	if (App->entitymanager->player->speed.y < 0.0f && App->entitymanager->player->position.y <= top_limit)
	{
	...
	if (App->entitymanager->player->speed.y > 0.0f && App->entitymanager->player->position.y + App->entitymanager->player->collider->rect.h > bot_limit)
	{
		App->render->camera.y -= App->entitymanager->player->speed.y;
